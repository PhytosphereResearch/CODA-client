        ...
        >
          ...
          <div className="content-box">
            ...
            <p>CODA database and its initial access program were originally developed for the
              ...
              to convert CODA to a web application and support for using the <a href="http://elib.cs.berkeley.edu:8080/photos/">CalPhotos</a> image library to serve images compiled for CODA. Additional funding in support of the CODA database has been provided by USDA-Forest Service Region 5 and Phytosphere Research.</p>
          </div>
        </Modal>
    );
  }
