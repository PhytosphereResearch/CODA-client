...
const Citing = props => (
  ...
  >
    ...
    <div className="content-box">
      ...
      <p>Swiecki, T. J; Bernhardt, E. A.; Arnold, R.A. 2003 - present. California oak disease and arthropod (CODA) database. Version 2014Dec16. [web application].  Vacaville, CA: Phytosphere Research. Available: https://coda.phytosphere.com/ [Accessed {'{'}insert access date{'}'}] </p>
    </div>
  </Modal>
);
